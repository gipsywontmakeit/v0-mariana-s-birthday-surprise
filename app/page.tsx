      ...
      <AnimatePresence mode="wait">
        ...
        {currentScreen === "wake-act1" && (
          ...
          >
            <SleepingEyes
              ref={eyesRef}
              onTextReady={handleTextReadyAct1}
              wakeStage={wakeTextStage}
            />
        ...
        {currentScreen === "wake-act2" && (
          ...
          >
            <SleepingEyes
              ref={eyesRef2}
              onTextReady={handleTextReadyAct2}
              wakeStage={wakeTextStage}
            />
